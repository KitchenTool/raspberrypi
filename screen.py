...
def get_image():
    ...
    location_kristin = request.urlopen('https://server-rho-sandy.vercel.app/location/kristin').read().decode()
    location_jens = request.urlopen('https://server-rho-sandy.vercel.app/location/Jens').read().decode()
